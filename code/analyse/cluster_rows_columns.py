...
def plot(K_range,average_counts,title):
    ...
    pyplot.title(title,y=1.03,fontsize=22)
    pyplot.xlabel("K",fontsize=18)#12)
    pyplot.ylabel("Average number of non-negative clusters",fontsize=18)#12)
    pyplot.show()
...
if __name__ == "__main__":
    ...
    plot(K_range_rows,average_counts_rows,title="Number of non-empty clusters for rows (cell lines)")
